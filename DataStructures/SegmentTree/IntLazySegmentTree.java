...
abstract class IntLazySegmentTree {
     ...
     */
    public IntLazySegmentTree(int[] dataNodes) {
     ...
     * @param n    The length of the segment
     */
    public IntLazySegmentTree(java.util.function.IntUnaryOperator init, int n) {
        this(n);
        for (int i = 0; i < n; i++)
            dataNodes[this.n + i] = init.applyAsInt(i);
     ...
     */
    public void rangeUpdate(int l, int r, int updateTo) {
        rangeUpdate(1, 0, n - 1, l, r, updateTo);
    }

    private void rangeUpdate(int p, int l, int r, int ql, int qr, int updateTo) {
        if (qr < l || ql > r) return;
     ...
     */
    private void applyAt(int p, int l, int r, int lazy) {
     ...
     */
    public int firstTrue(int l, int r, java.util.function.IntPredicate condition) {
        return firstTrue(1, 0, n - 1, l, r, condition);
    }

    private int firstTrue(int p, int l, int r, int ql, int qr, java.util.function.IntPredicate condition) {
     ...
     */
    public int lastTrue(int l, int r, java.util.function.IntPredicate condition) {
        return lastTrue(1, 0, n - 1, l, r, condition);
    }

    private int lastTrue(int p, int l, int r, int ql, int qr, java.util.function.IntPredicate condition) {
     ...
     */
    public abstract int apply(int data, int l, int r, int lazy);
