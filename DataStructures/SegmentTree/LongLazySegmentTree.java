...
abstract class LongLazySegmentTree {
    ...
    private int firstTrue(int p, int l, int r, int ql, int qr, java.util.function.LongPredicate condition) {
    ...
    private int lastTrue(int p, int l, int r, int ql, int qr, java.util.function.LongPredicate condition) {
