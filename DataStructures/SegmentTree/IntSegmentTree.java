...
abstract class IntSegmentTree {
    ...
    private int firstTrue(int v, int l, int r, int ql, int qr, java.util.function.IntPredicate condition) {
    ...
    private int lastTrue(int v, int l, int r, int ql, int qr, java.util.function.IntPredicate condition) {
